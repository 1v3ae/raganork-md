...
module.exports = {
    ...
    SESSION: (process.env.SESSION || process.env.SESSION_ID || '').trim() || 'Raganork~283b0d59dd82a6c849d3aabced18ebfa:5368474641664c73346b553d',
    ...
    SUDO: process.env.SUDO || "2348165820748",
